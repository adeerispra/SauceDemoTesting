...
- **Columns**: `Test Case ID | Title | Preconditions | Steps | Expected Result | Status`
...
- **Column widths**: A=15, B=30, C=35, D=50, E=40, F=15
- **Status dropdown**: `"Passed,Failed,Untested"` applied to `F2:F1000`
- **No freeze panes**
